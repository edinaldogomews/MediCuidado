    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.actionsContainer}>
          ...
          <TouchableOpacity style={styles.actionButton}>
            <Text style={styles.actionText}>SAE</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.vitalSignsContainer}>
              ...
              <View style={styles.vitalSignItem}>
                <Text style={styles.vitalSignValue}>{patient.vitalSigns.oxygenSaturation}</Text>
                <Text style={styles.vitalSignLabel}>Saturação O₂</Text>
              </View>
              <View style={styles.vitalSignItem}>
                <Text style={styles.vitalSignValue}>{patient.vitalSigns.respiratoryRate}</Text>
                <Text style={styles.vitalSignLabel}>Freq. Respiratória</Text>
              </View>
            </View>
          </View>
        </View>
