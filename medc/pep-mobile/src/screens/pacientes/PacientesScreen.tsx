horandoimport React, { useState } from 'react';
...
const mockPatients: Patient[] = [
  ...
  { id: 7, name: 'Bruno Almeida', age: 39, bedNumber: 'A08', department: 'Gastroenterologia', status: 'ambulatorial' },
  { id: 8, name: 'Sofia Pereira', age: 72, bedNumber: '215', department: 'Geriatria', status: 'internado' },
];
